      ...
      <main className="relative h-[480px] bg-[#006cc7] overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 w-full max-w-[360px] bg-white rounded shadow-2xl overflow-hidden mr-[-20%]">
          ...
          <form onSubmit={handleLogin} className="p-8 space-y-5">
            ...
            <button type="submit" disabled={isLoading} className="w-full py-2 bg-[#0078d7] text-white font-medium rounded hover:bg-[#006cc7] transition-colors shadow-sm disabled:opacity-50 disabled:cursor-not-allowed">
