          ...
          <div className="w-full max-w-[380px] bg-white rounded-lg shadow-2xl overflow-hidden flex">
            ...
            <div className="flex-grow p-8">
              ...
              <form onSubmit={handleLogin} className="space-y-6">
                ...
                <button type="submit" disabled={isLoading} className="w-full py-3 bg-[#ff4d4f] hover:bg-[#e03a3c] text-white font-medium rounded transition-colors text-[16px] shadow-lg shadow-red-200 disabled:opacity-50 disabled:cursor-not-allowed">
                  {isLoading ? '验证中...' : '登 录'}
                </button>
