            ...
            <div className="p-8 space-y-6">
              {activeTab === 'account' ? (
                <form onSubmit={handleLogin} className="space-y-6">
                  ...
                  <button type="submit" disabled={isLoading} className="w-full py-3 bg-[#e64a19] hover:bg-[#d84315] text-white font-medium rounded transition-colors text-[16px] shadow-sm tracking-widest disabled:opacity-50 disabled:cursor-not-allowed">
                    {isLoading ? '验证中...' : '登录'}
                  </button>
