          ...
          <div className="w-full max-w-[360px] bg-[#f0f5fa]/90 backdrop-blur-sm rounded-md shadow-2xl overflow-hidden flex flex-col h-[380px]">
            ...
            <div className="p-8 flex flex-col flex-grow">
              ...
              <form onSubmit={handleLogin} className="space-y-4 flex-grow flex flex-col">
                ...
                <button type="submit" disabled={isLoading} className="w-full py-2 bg-[#42a2f0] hover:bg-[#3292e0] text-white font-medium rounded-sm transition-colors text-[16px] shadow-sm disabled:opacity-50 disabled:cursor-not-allowed">
